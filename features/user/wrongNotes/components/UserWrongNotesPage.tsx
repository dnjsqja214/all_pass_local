...
import { WrongExamSelection } from "./WrongExamSelection/WrongExamSelection";
import { WrongNotesDetail } from "./WrongNotesDetail/WrongNotesDetail";
...
export function UserWrongNotesPage() {
